...
## 4. Collect results
Once the job is finished, locate the files returned and verify the results are what we expected.  run: <p> 
find -name “output_results” <p>
Find the channel by running : find -name "match_ch.txt" <p>
